...
<br />
{if $country == 'NL'}
<img style="float:right;margin-bottom:15px;width:160px;" src="./modules/billmateinvoice/img/warning-product.jpg" alt="warning dutch"/>
<br />
{/if}
<div style="display: block;" class="billmate_PPBox" id="billmate_PPBox">
    <div style="display: none" id="billmate_invoice"></div>
    <div class="billmate_PPBox_inner">
         <div class="billmate_PPBox_top">
            ...
            <div class="billmate_PPBox_topMid">
              <span>{l s='From' mod='billmateinvoice'}<label>{displayPrice price=$minValue}</label>{l s='Month' mod='billmateinvoice'}*</span>
            </div>
         </div>
         <div class="billmate_PPBox_bottom">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <thead>
                        <tr>
                            ...
                            <th class="billmate_column_right">{l s='Total/Month' mod='billmateinvoice'}</th>
                        </tr>
                    </thead>
                    <tbody>
			...
			{/foreach}
                  ...
                  <div class="billmate_PPBox_bottomMid_readMore"><a id="billmate-link-dynamic" class="billmate-link" href="#">{l s='Read More' mod='billmateinvoice'}</a></div>
...
<div id="billmate_terms_condition" style="display:none;position:absolute;top:30px;left:50%;margin-left:-300px;background-color: #FFFFFF;border: 1px solid black;border-radius: 2px 2px 2px 2px;box-shadow: 4px 4px 4px #888888;padding: 0 0 10px;z-index: 9999;"><iframe style="width: 550px;height:680px;border:0" src="{$linkTermsCond}"></iframe><br/><p style="cursor:pointer" onclick="closeIframe('billmate_terms_condition')">{l s='Close' mod='billmateinvoice'}</p></div>
