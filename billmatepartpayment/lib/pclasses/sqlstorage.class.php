...
/**
 * SQL storage class for BillmatePClass
 *
...
class SQLStorage extends PCStorage
{
    ...
    protected function splitURI($uri)
    {
        ...
        if (preg_match($pdo_rex, $uri, $arr) === 1) {
             ...
             */
            if (count($arr) != 6) {
                throw new Billmate_DatabaseException(
    ...
    protected function getConnection($uri)
    {
        ...
        try {
            ...
            throw new Billmate_DatabaseException('Failed to connect to database!');
        }
    }
...
SQL;
    ...
    protected function clearTable()
    {
        try {
            ...
            throw new Billmate_DatabaseException('Could not clear the database!');
        }
    }
}
