...
class BillmateAddr
{
    ...
    /**
     * When using {@link Billmate::getAddresses()} this might be guessed
     ...
     * @param string|int $country  BillmateCountry constant or two letter code.
    ...
    public function __construct(
        ...
        $lname = null, $company = "", $street = null, $zip = null,
     ...
     * or the value set with {@link Billmate::setReference()}.
     *
    ...
    public function getCountryCode()
    {
        ...
        case BillmateCountry::SE:
            return 'se';
        default:
            throw new Billmate_UnsupportedCountryException($this->country);
        }
    }
    ...
    public function setCountry($country)
    {
        ...
        if (strlen($country) == 2 || strlen($country) == 3) {
            $this->setCountry(BillmateCountry::fromCode($country));
            return;
        }
        throw new BillmateException("Failed to set country! ($country)");
    }
