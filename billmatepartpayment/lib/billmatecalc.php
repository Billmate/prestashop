...
class BillmateCalc
{
     ...
     * @param BillmatePClass $pclass BillmatePClass used to calculate the APR.
    ...
    {
        if (!is_numeric($sum)) {
            throw new Billmate_InvalidTypeException('sum', 'numeric');
        }
        ...
        if (!is_numeric($free)) {
            throw new Billmate_InvalidTypeException('free',  'integer');
        }
     ...
     *
     * @param float        $sum    The sum for the order/product.
     * @param BillmatePClass $pclass PClass used to calculate total credit cost.
     * @param int          $flags  Checkout or Product page.
     *
     * @throws BillmateException
     ...
     * @param BillmatePClass $pclass PClass used to calculate monthly cost.
     * @param int          $flags  Checkout or product page.
     *
     * @throws BillmateException
