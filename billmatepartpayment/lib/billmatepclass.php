 ...
 *
 * PClasses are used in conjunction with BillmateCalc to determine part payment costs.
 *
 * @ignore    Do not show in PHPDoc.
 * @category  Payment
 * @package   BillmateAPI
...
class BillmatePClass
{
     ...
     *
     * @see BillmateCountry
     * @return int {@link BillmateCountry} constant.
     */
