...
require_once(_PS_MODULE_DIR_.'/billmategateway/classes/PaymentConfigValidator.php');
...
class BillmateGateway extends PaymentModule {
        ...
        /**
         * @var PaymentConfigValidator
         */
		protected $paymentConfigValidator;
		...
		public function __construct()
		{
			...
			$this->paymentConfigValidator = new PaymentConfigValidator($this);
		...
		public function _postValidation()
		{
           ...
           $errors = $this->getPaymentConfigValidator()->checkAvailabilityTestMode();
            if ($errors) {
                $this->postErrors = array_merge($this->postErrors, $errors);
            }
		}
        ...
        /**
         * @return PaymentConfigValidator
         */
        public function getPaymentConfigValidator()
        {
            return $this->paymentConfigValidator;
        }
    }
